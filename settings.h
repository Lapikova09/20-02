...
const sf::Vector2f TEXT_POS1{ 680.f,500.f };
const sf::Vector2f LIFE1_POS{ 625.f,200.f };
const sf::Vector2f LIFE2_POS{ 675.f,200.f };
const sf::Vector2f LIFE3_POS{ 725.f,200.f };
